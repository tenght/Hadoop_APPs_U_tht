...
public class MapFileSeekTest {
	...
	private static final String MAP_URI = "hdfs://master:9000/mapfile/numbers.map";
	...
	public void seek2() throws Exception {
		assertThat(reader.seek(new IntWritable(1024)), is(true));
		assertThat(reader.next(key, value), is(false));
		assertThat(((IntWritable) key).get(), is(0));
		assertThat(((Text) value).toString(), is(""));
	}
